...
{
  Serial.begin(9600);
  Serial.println("Prueba Lectura de huella");
...
{
  Serial.println("Presione cualquier caracter para inscribir huella...");
  while (Serial.available() == 0) yield();
  Serial.println("Buscando un espacio libre para almacenar la plantilla...");
  int16_t id;
  if (get_free_id(&id))
    getFingerprintEnroll(id);
  else
    Serial.println("No hay espacio libre en la biblioteca flash!");
